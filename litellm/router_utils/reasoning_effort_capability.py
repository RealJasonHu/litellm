...
An entry that states its levels outright in supported_reasoning_efforts is read first and wins
...
_DECLARED_EFFORTS_KEY: Final = "supported_reasoning_efforts"
...
def _declared_effort_list(model_info: Mapping[str, object]) -> tuple[str, ...] | None:
...
def resolve_supported_reasoning_efforts(
    ...
    *,
    ...
    declared: Final = _declared_effort_list(model_info)
